...
class TestConsole(unittest.TestCase):
    ...
    def test_cmd_update_with_params(self, mock_stdout):
        """Test update command with params"""
        self.console.onecmd("create BaseModel")
        id = mock_stdout.getvalue().strip()
    ...
    def test_cmd_update_invalid_attribute(self, mock_stdout):
        """Test update command with multiple params"""
        self.console.onecmd("create BaseModel")
        id = mock_stdout.getvalue().strip()
    ...
    def test_cmd_update_with_different_attribute_types(self, mock_stdout):
        """Test update command with different attribute types"""
        self.console.onecmd("create BaseModel")
        id = mock_stdout.getvalue().strip()
    ...
    def test_emptyline(self):
        """test the empty line and enter cmd"""
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("")
    ...
    def test_create(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("create Husam")
